...
if (file_exists(_file_path)) {
	...
	file_text_readln(file);
	ds_list_read(obj_MCP.player_is_occupied, file_text_read_string(file));
	file_text_readln(file);
	ds_list_read(obj_MCP.player_value, file_text_read_string(file));
	file_text_readln(file);
	ds_list_read(obj_MCP.scrap_is_occupied,file_text_read_string(file));
	file_text_readln(file);
	ds_list_read(obj_MCP.scrap_value, file_text_read_string(file));
	file_text_readln(file);
